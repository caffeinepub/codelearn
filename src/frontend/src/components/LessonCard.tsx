...
import { CheckCircle2, ChevronRight, Lock, Zap } from "lucide-react";
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-2">
              ...
              {isCompleted && (
                <Badge
                  variant="outline"
                  className="text-xs bg-success/10 text-success border-transparent"
                >
                  Completed ✓
                </Badge>
              )}
              {isLocked && (
                <Badge
                  variant="outline"
                  className="text-xs bg-muted/50 text-muted-foreground border-transparent"
                >
              ...
              {!isLocked && !isCompleted && (
                <Badge
                  variant="outline"
                  className="text-xs bg-python-blue/10 text-python-blue border-transparent"
                >
